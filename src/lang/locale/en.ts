...
const en = {
    ...
    'Define custom status emojis that can be applied to cards in specific lanes':
        'Define custom status emojis that can be applied to cards in specific lanes',
    'Add Status Emoji': 'Add Status Emoji',
    Emoji: 'Emoji',
    Name: 'Name',
    'Status name': 'Status name',
    'Mark as completion status': 'Mark as completion status',
    'If enabled, this status will be considered as a completion status':
        'If enabled, this status will be considered as a completion status',
    'In Progress': 'In Progress',

    // components/Lane/LaneSettings.tsx
    'Apply status to cards in this list': 'Apply status to cards in this list',
    None: 'None',
